...
@section('content')
    ...
    <div class="card card-info">
        ...
        <form class="form" action="{{ route('categoria.update', [$category->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="col-sm-10">
                    <input type="file" value="{{$category->image}}" onchange="getImage()" name="image" id="inputImage" class="d-none">
                </div>
    ...
    <script>
        ...
        function getImage() {
            ...
            if(imageName != undefined) {
                image.innerHTML = '<p  class="alert alert-succcess">'+imageName+'</p>';
            } else {
